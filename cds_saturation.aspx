<%@ Page Title="" Language="C#" MasterPageFile="~/SaturationMain.master" AutoEventWireup="true" CodeFile="cds_saturation.aspx.cs" Inherits="cds_saturation" %>
        ...
        <table id="dev_table" class="table table-hover" style="margin-top: 10px;">
            ...
            <tbody class="text-center">
                <tr>
                    ...
                    <td><a href="/cdschild_saturation.aspx" class="btn btn-sm btn-default">View</a></td>
                </tr>
                <tr>
                    <td>156703</td>
                    <td>Cholinerv 1g</td>
